...
public class MovieService1 implements IMovieService{
    ...
    private static List<Movie> getDefaultList()
    {
        ...
        movies.add(new Movie(1,"Cloud Atlas1",MovieStyles.SF,2012, "FR-987654", "https://fr.web.img5.acsta.net/medias/nmedia/18/92/29/61/20471737.jpg"));
        movies.add(new Movie(2,"Shutter Island1",MovieStyles.THRILLER,2010, "FR-987654", "https://fr.web.img2.acsta.net/c_310_420/medias/nmedia/18/69/96/84/19151192.jpg"));
        ...
        movies.add(new Movie(5,"Mulholland Drive1",MovieStyles.THRILLER,2001, "FR-987654", "https://fr.web.img3.acsta.net/c_310_420/pictures/21/12/08/16/03/5133751.jpg"));
